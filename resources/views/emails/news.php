                                        ...
                                        <tr>
                                            <td style="padding-right:5%" width="100%">
                                                    <p style="font-size:18px;font-weight:700;color:#404040;line-height:24px;margin:0 0 15px 0">
                                                        Salut <?php echo $user->username ?>, il y a des nouveautés sur ZombiLingo !
                                                    </p>
                                                    ...
                                                    <p style="color:#404040;font-size:15px;font-weight:normal;line-height:24px;margin:15px 0 0 0;">
                                                        À bientôt sur <a href="http://www.zombilingo.org" style="text-decoration:none;color:#888;" target="_blank">Zombilingo</a>,<br/>
                                                        Bob le Zombie.
                                                    </p>
                                            </td>
                                    </tr></tbody></table>
